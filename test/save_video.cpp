...
int main()
{
    cv::String file_path = "../examples/Sub_project.mp4";
    ...
    double fps = 60;
    cv::Size size(cvRound(cap.get(cv::CAP_PROP_FRAME_WIDTH)),
                  cvRound(cap.get(cv::CAP_PROP_FRAME_HEIGHT)));
    cv::VideoWriter output_video("../result/output_60.avi", fourcc, fps, size);
